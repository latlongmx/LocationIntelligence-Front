(function(){
	...
	*/
	...
	function paymentsAgeDirective(_, odService, uiService, $rootScope){
		...
		return {
			...
			scope: '=',
			template: [
				'<div id="payment-age"></div>'
			].join(''),
			link: function(scope, element, attr, ctrl){
				$rootScope.$on('paymentsAge', function(e, data){
					paymentAgeChart(data);
					e.stopPropagation();
				});

				function paymentAgeChart(age) {

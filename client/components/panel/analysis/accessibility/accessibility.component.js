					...
					'<div class="m-side-panel js-accessibility-side-panel">',
						...
						'<div class="m-side-panel__actions pos-relative">',
							'<div layout="row">',
								...
								'</div>',
								'<div layout="column" flex="50" layout-align="center center">',
									'<md-button id="btnAddNewPoly" aria-label="" class="md-raised md-fab md-mini leaflet-draw-draw-polygon" title="Dibujar Poligono" ng-click="drawInMap($event,\'polygon\')">Hola</md-button>',
								'</div>',
								'<div layout="column" flex="50" layout-align="center center">',
									'<md-button id="btnAddNewRadio" aria-label="area-tool" class="md-raised md-fab md-mini leaflet-draw-draw-circle" title="Dibujar Radio" ng-click="drawInMap($event,\'circle\')">',

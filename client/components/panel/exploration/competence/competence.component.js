						...
						'<div class="m-side-panel__list m-side-panel__list--in-competence-panel">',
							'<ul class="m-side-panel__list-content">',
								'<li class="m-side-panel__list-content__item js-competence-item" ng-repeat="competence in save_competence_variable_list | filter: search_competence">',
									...
									'<md-switch ng-disabled="is_toggle_gral_competence" ng-model="layer" flex="10" md-no-ink aria-label="competence.id_layer" ng-change="turnOnOffLayerCompetence(layer, competence)" class="md-primary m-side-panel__list-content__item-single"></md-switch>',
									'<md-button data-id-competence="competence.id_layer" class="md-icon-button md-button md-ink-ripple m-side-panel__list-content__item-single" ng-click="zoomToCompetenceLayer(competence.id_layer, competence.name_layer)" ng-init="disabled" ng-disabled="layer === false">',
										'<md-icon>zoom_in</md-icon>',
									'</md-button>',

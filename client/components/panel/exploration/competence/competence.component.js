							...
							'<div layout="row">',
								...
								'<div flex="50" layout="row" layout-align="center center" class="m-side-panel__actions-columns">',
									'<div layout="row" layout-align="center center">',
										...
										'</div>',
										'<div flex="25">',
												'<md-switch class="md-primary" aria-label="all-competences" ng-model="all_competences" ng-change="toggleGralCompetences(competence)"></md-switch>',
										'</div>',
									'</div>',
						...
						'<div class="m-side-panel__list m-side-panel__list--in-competence-panel">',
							'<ul class="m-side-panel__list-content">',
								'<li class="m-side-panel__list-content__item js-competence-item" ng-repeat="competence in save_competence_variable_list | filter: search_competence">',
									...
									'<md-switch ng-disabled="is_toggle_gral_competence" ng-model="layer" flex="10" md-no-ink aria-label="competence.id_layer" ng-change="turnOnOffLayerCompetence(layer, competence)" class="md-primary md-hue-3 m-side-panel__list-content__item-single"></md-switch>',

				...
				'<div>',
					...
					'<div class="m-side-panel js-location-side-panel">',
						...
						'<div class="m-side-panel__actions pos-relative">',
							'<div layout="row">',
								'<div layout="row" flex="40" layout-align="center center" class="m-side-panel__actions-columns">',
									'<div flex="75">',
										'<h5 class="m-side-panel__title-action">Agregar ubicación</h5>',
									'</div>',
									'<div flex="25">',
								...
								'<div layout="row" flex="60" layout-align="center center" class="m-side-panel__actions-columns">',
									'<div flex="80" layout-align="center end">',
										'<h5 class="m-side-panel__title-action">Mostrar/ocultar Capas activas</h5>',
									'</div>',
									'<div flex="20">',
						...
						'<div class="m-side-panel__header">',
							'<h4 class="m-side-panel__user-title">Mis ubicaciones</h4>',
								'<ul class="m-side-panel__list-titles">',
									'<li flex="10" class="m-side-panel__list-column-title">Icono</li>',
									'<li flex="35" class="m-side-panel__list-column-title">Nombre Ubicación</li>',
									'<li flex="20" class="m-side-panel__list-column-title"># Sucursales</li>',

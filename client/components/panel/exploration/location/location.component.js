								...
								'<div layout="row" flex="60" layout-align="center center" class="m-side-panel__actions-columns">',
									...
									'<div flex="20">',
										'<div layout-align="center center" >',
											'<md-switch class="md-primary" aria-label="all-locations" ng-model="all" ng-change="toggleGral(location)"></md-switch>',
										'</div>',
									'</div>',
								'</div>',
							'</div>',
						...
						'<div class="m-side-panel__list m-side-panel__list--in-location-panel">',
							'<ul class="m-side-panel__list-content">',
								'<li class="m-side-panel__list-content__item js-location-item" ng-repeat="location in locations | filter: search_location">',
									...
									'<md-switch ng-disabled="is_toggle_gral" ng-model="layer" flex="10" md-no-ink aria-label="location.id_layer" ng-change="turnOnOffLayer(layer, location)" class="md-primary md-hue-3 m-side-panel__list-content__item-single"></md-switch>',
